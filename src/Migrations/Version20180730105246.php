 ...
 */
final class Version20180730105246 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tecnologia_candidato (tecnologia_id INT NOT NULL, candidato_id INT NOT NULL, INDEX IDX_5F09D6F321F9EE65 (tecnologia_id), INDEX IDX_5F09D6F3FE0067E5 (candidato_id), PRIMARY KEY(tecnologia_id, candidato_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE candidatos (id INT AUTO_INCREMENT NOT NULL, cargo_id INT DEFAULT NULL, endereco_id INT DEFAULT NULL, nome VARCHAR(255) NOT NULL, sexo VARCHAR(1) NOT NULL, data_nascimento DATE NOT NULL, idade INT NOT NULL, pretensao_salarial NUMERIC(2, 0) NOT NULL, foto VARCHAR(255) NOT NULL, INDEX IDX_90981086813AC380 (cargo_id), INDEX IDX_909810861BB76823 (endereco_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE candidatura (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tecnologia_candidato DROP FOREIGN KEY FK_5F09D6F321F9EE65');
        $this->addSql('ALTER TABLE candidatos_tecnologias DROP FOREIGN KEY FK_98D2309321F9EE65');
        $this->addSql('ALTER TABLE tecnologia_candidato DROP FOREIGN KEY FK_5F09D6F3FE0067E5');
